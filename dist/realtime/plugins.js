 ...
 */
export function buildModbusFrame(slaveId, functionCode, data) {
 ...
 */
export function buildReadRegistersFrame(slaveId, startAddress, quantity) {
 ...
 */
export function buildWriteRegisterFrame(slaveId, address, value) {
    const data = Buffer.alloc(4);
