...
const generateRecoveryCodes = (count = 8) => Array.from({ length: count }, () => `${crypto.randomBytes(3).toString('hex').slice(0, 4)}-${crypto.randomBytes(3).toString('hex').slice(0, 4)}`.toUpperCase());
// ===== ENCRYPTION =====
