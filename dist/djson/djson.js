...
// Shortcuts
export const djson = (data, format) => DJSON.parse(data, format);
export const djsonSafe = (data, format) => DJSON.parseSafe(data, format);
export const dencode = (data, format = 'json') => DJSON.encode(data, format);
export const toBuffer = (data) => DJSON.encode(data, 'buffer');
export const toQueryString = (data) => DJSON.encode(data, 'querystring');
export const toKeyValue = (data) => DJSON.encode(data, 'keyvalue');
export const toHex = (data) => DJSON.encode(data, 'hex');
export const toBase64 = (data) => DJSON.encode(data, 'base64');
