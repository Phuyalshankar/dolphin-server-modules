...
import { getFrameworkPrompt } from './config.js';
...
export class DolphinAgent {
    ...
    updateSemanticIndex(filePath, content) {
    ...
    async saveHistory(role, content) {
        try {
