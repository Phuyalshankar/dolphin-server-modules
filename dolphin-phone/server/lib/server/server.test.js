...
describe('Dolphin Server', () => {
    ...
    const PORT = 4567;
    beforeAll(() => {
        server = (0, server_1.createDolphinServer)();
        // Basic routes
    ...
    it('should respond to GET requests', (done) => {
        node_http_1.default.get(`http://localhost:${PORT}/ping`, (res) => {
            let data = '';
    ...
    it('should respond with text', (done) => {
        node_http_1.default.get(`http://localhost:${PORT}/text`, (res) => {
            let data = '';
            res.on('data', (chunk) => data += chunk);
            res.on('end', () => {
    ...
    it('should respond with HTML', (done) => {
        node_http_1.default.get(`http://localhost:${PORT}/html`, (res) => {
            let data = '';
            res.on('data', (chunk) => data += chunk);
            res.on('end', () => {
    ...
    it('should support status codes', (done) => {
        node_http_1.default.get(`http://localhost:${PORT}/status-201`, (res) => {
            let data = '';
            res.on('data', (chunk) => data += chunk);
            res.on('end', () => {
    ...
    it('should support 404 status code', (done) => {
        node_http_1.default.get(`http://localhost:${PORT}/status-404`, (res) => {
            let data = '';
            res.on('data', (chunk) => data += chunk);
            res.on('end', () => {
    ...
    it('should support custom headers', (done) => {
        node_http_1.default.get(`http://localhost:${PORT}/headers`, (res) => {
            let data = '';
            res.on('data', (chunk) => data += chunk);
            res.on('end', () => {
    ...
    it('should parse query parameters', (done) => {
        node_http_1.default.get(`http://localhost:${PORT}/query?name=john&age=25&city=kathmandu`, (res) => {
            let data = '';
            res.on('data', (chunk) => data += chunk);
            res.on('end', () => {
    ...
    it('should support single route parameter', (done) => {
        node_http_1.default.get(`http://localhost:${PORT}/user/123`, (res) => {
            let data = '';
            res.on('data', (chunk) => data += chunk);
            res.on('end', () => {
                const result = JSON.parse(data);
    ...
    it('should support multiple route parameters', (done) => {
        node_http_1.default.get(`http://localhost:${PORT}/user/456/post/789`, (res) => {
            let data = '';
            res.on('data', (chunk) => data += chunk);
            res.on('end', () => {
                const result = JSON.parse(data);
    ...
    it('should support chained methods', (done) => {
        node_http_1.default.get(`http://localhost:${PORT}/chain`, (res) => {
            let data = '';
            res.on('data', (chunk) => data += chunk);
            res.on('end', () => {
    ...
    it('should return 404 for non-existent routes', (done) => {
        node_http_1.default.get(`http://localhost:${PORT}/non-existent-route-123`, (res) => {
            let data = '';
            res.on('data', (chunk) => data += chunk);
            res.on('end', () => {
                expect(res.statusCode).toBe(404);
    ...
    it('should handle multiple query parameters', (done) => {
        node_http_1.default.get(`http://localhost:${PORT}/query?search=dolphin&page=2&limit=10&sort=desc`, (res) => {
            let data = '';
            res.on('data', (chunk) => data += chunk);
            res.on('end', () => {
                const result = JSON.parse(data);
    ...
    it('should handle empty query parameters', (done) => {
        node_http_1.default.get(`http://localhost:${PORT}/query`, (res) => {
            let data = '';
            res.on('data', (chunk) => data += chunk);
            res.on('end', () => {
                const result = JSON.parse(data);
    ...
    it('should handle special characters in route parameters', (done) => {
        node_http_1.default.get(`http://localhost:${PORT}/user/john_doe-123`, (res) => {
            let data = '';
            res.on('data', (chunk) => data += chunk);
            res.on('end', () => {
                const result = JSON.parse(data);
